...
public class ResourceServerProdConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/v2/api-docs", "/swagger-resources/**",  "/swagger-ui.html**", "/webjars/**", "/top-summary", "/top-summary/search", "/bing", "favicon.ico","/wx","/wx/**").permitAll()
